...
export const Doctruyen3QInfo: SourceInfo = {
    ...
    icon: 'icon.png',
    author: 'dongtho123',
    authorWebsite: 'https://github.site/dongtho123',
...
export class Doctruyen3Q extends Source {
    ...
    async getSearchResults(query: SearchRequest, metadata: any): Promise<PagedResults> {
        ...
        const request = createRequestObject({
            url: encodeURI(`https://doctruyen3qmax.com/tim-truyen/${search.cate}?keyword=${query.title ?? ""}&sort=${search.sort}&status=${search.status}&page=${page}`),
            method: "GET",
        });
