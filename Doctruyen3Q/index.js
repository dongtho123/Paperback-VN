(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.Sources = f()}})(function(){var define,module,exports;return (function(){function r(e,n,t){function o(i,f){if(!n[i]){if(!e[i]){var c="function"==typeof require&&require;if(!f&&c)return c(i,!0);if(u)return u(i,!0);var a=new Error("Cannot find module '"+i+"'");throw a.code="MODULE_NOT_FOUND",a}var p=n[i]={exports:{}};e[i][0].call(p.exports,function(r){var n=e[i][1][r];return o(n||r)},p,p.exports,r,e,n,t)}return n[i].exports}for(var u="function"==typeof require&&require,i=0;i<t.length;i++)o(t[i]);return o}return r})()({1:[function(require,module,exports){
    ...
    const DOMAIN = 'https://doctruyen3qmax.com/';
    const method = 'GET';
    exports.Doctruyen3QInfo = {
        ...
        icon: 'icon.png',
        author: 'JustaTama',
        authorWebsite: 'https://github.site/JustaTama',
    ...
    class Doctruyen3Q extends paperback_extensions_common_1.Source {
        ...
        getHomePageSections(sectionCallback) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                request = createRequestObject({
                    url: 'https://doctruyen3qmax.com/hot',
                    method: "GET",
                });
                let popular = [];
                ...
                //boy
                request = createRequestObject({
                    url: 'https://doctruyen3qmax.com/truyen-con-trai',
                    method: "GET",
                });
                data = yield this.requestManager.schedule(request, 1);
                $ = this.cheerio.load(data.data);
                ...
                //girl
                request = createRequestObject({
                    url: 'https://doctruyen3qmax.com/truyen-con-gai',
                    method: "GET",
                });
                data = yield this.requestManager.schedule(request, 1);
                $ = this.cheerio.load(data.data);
        ...
        getViewMoreItems(homepageSectionId, metadata) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                switch (homepageSectionId) {
                    case "hot":
                        url = `https://doctruyen3qmax.com/hot?page=${page}`;
                        break;
                    case "new_updated":
                        url = `https://doctruyen3qmax.com/?page=${page}`;
                        break;
                    case "boy":
                        url = `https://doctruyen3qmax.com/truyen-con-trai?page=${page}`;
                        break;
                    case "girl":
                        url = `https://doctruyen3qmax.com/truyen-con-gai?page=${page}`;
                        break;
                    default:
        ...
        getSearchResults(query, metadata) {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const request = createRequestObject({
                    url: encodeURI(`https://doctruyen3qmax.com/tim-truyen/${search.cate}?keyword=${(_d = query.title) !== null && _d !== void 0 ? _d : ""}&sort=${search.sort}&status=${search.status}&page=${page}`),
                    method: "GET",
                });
                let data = yield this.requestManager.schedule(request, 1);
                let $ = this.cheerio.load(data.data);
        ...
        getSearchTags() {
            return __awaiter(this, void 0, void 0, function* () {
                ...
                const tags2 = [];
                const tags5 = [];
                const url = 'https://doctruyen3qmax.com/tim-truyen';
                const request = createRequestObject({
                    url: url,
                    method: "GET",
                });
